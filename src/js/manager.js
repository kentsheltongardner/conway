...
export default class Manager {
    ...
    randomizationRange = document.getElementById('randomization-range');
    iterationsRange = document.getElementById('iterations-range');
    speedRange = document.getElementById('speed-range');
    checkboxes = document.querySelectorAll('input[type="checkbox"]');
    onCheckboxes = document.getElementsByClassName('on-checkbox');
    offCheckboxes = document.getElementsByClassName('off-checkbox');
    ...
    updateType() {
        return document.querySelector('input[name="update-type"]:checked').value;
    }
    step() {
    ...
    renderGridLines(rect, cellSize, ctx) {
        const left = rect.x;
